...
export default function AboutPage() {
  return (
    <div className="bg-background">
      ...
      <div className="mx-auto max-w-6xl space-y-14 px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <section className="mx-auto max-w-3xl rounded-lg border border-border bg-surface p-6 sm:p-8">
          <h2 className="font-heading text-xl font-semibold text-foreground sm:text-2xl">
            Contact
          </h2>
          <p className="mt-4 text-muted leading-relaxed">
          ...
          <Link
            href="/contact"
            className="mt-4 inline-flex font-semibold text-primary no-underline hover:text-primary-hover"
          >
            Go to contact page →
          </Link>
        </section>
        ...
        <div
          className="mx-auto max-w-3xl rounded-lg border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-amber-950 sm:px-5 sm:py-5"
          role="note"
        >
